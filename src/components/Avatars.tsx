...
const Avatars: React.FC<AvatarsProps> = ({ author }) => {
  ...
  return (
    <div className={`flex items-center justify-between mb-2 bg-[url('@/images/background.png')] bg-cover bg-no-repeat bg-center h-96 w-full rounded-lg md:justify-evenly`}>
      <img
