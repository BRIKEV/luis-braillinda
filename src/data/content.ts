...
export const bookContent: Entry[] = [
  ...
  {
    author: "Narrador",
    message: "Después de jugar con las vocales acentuadas, Braillinda quiso saber cómo se indicaría, con ese sistema, cuándo una letra va en mayúscula.",
    backdrop: "workshop",
    left: "luis",
    right: "braillinda",
  },
  {
    author: "Luis",
    message: "Muy fácil. Inventaremos un signo.",
    backdrop: "workshop",
    left: "luis",
    right: "braillinda",
  },
  {
    author: "Braillinda",
    message: "¿Y va a ir antes o después?",
    backdrop: "workshop",
    left: "luis",
    right: "braillinda",
  },
  {
    author: "Luis",
    message: "Antes, antes. Debe de ir antes de la letra.",
    backdrop: "workshop",
    left: "luis",
    right: "braillinda",
  },
  ...
  {
    author: "Luis",
    message: "¿El seis solo? Mejor por qué no utilizamos el 4 6?<br><BRAILLE>^</BRAILLE>",
    backdrop: "workshop",
    left: "luis",
    right: "braillinda",
  },
  {
    author: "Braillinda",
    message: "Bueno, anotemos unos nombres propios a ver cómo quedan con mayúsculas.",
    backdrop: "workshop",
    left: "luis",
    right: "braillinda",
  },
  {
    author: "Luis",
    message: "¿En orden alfabético o como se nos ocurran?",
    backdrop: "workshop",
    left: "luis",
    right: "braillinda",
  },
  {
    author: "Braillinda",
    message: "Como se nos ocurran. ¡Venga!",
    backdrop: "workshop",
    left: "luis",
    right: "braillinda",
  },
